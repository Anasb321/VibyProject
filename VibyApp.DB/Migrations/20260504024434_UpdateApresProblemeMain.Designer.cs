...
namespace VibyApp.DB.Migrations
{
    ...
    [Migration("20260504024434_UpdateApresProblemeMain")]
    partial class UpdateApresProblemeMain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VibyApp.DB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "Vibe",
                            MotDePasse = "$2a$11$il3QAwJKmK8MRBA.UKzq4eX/keDhq4RqZFruFno/a/uOpEF9EUFfK",
                            UserName = "admin"
                        });
                });
